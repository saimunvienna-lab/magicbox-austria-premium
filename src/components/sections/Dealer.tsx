        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <form onSubmit={onSubmit} className="glass-dark rounded-3xl p-6 sm:p-10 space-y-4">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <Input name="company" placeholder={t("f_company")} required maxLength={150} className="h-12 rounded-xl bg-white/5 border-white/10 text-primary-foreground placeholder:text-primary-foreground/50" />
            </div>
            <div className="grid sm:grid-cols-2 gap-4">
              <Input name="country" placeholder={t("f_country")} required maxLength={80} className="h-12 rounded-xl bg-white/5 border-white/10 text-primary-foreground placeholder:text-primary-foreground/50" />
              <Input name="volume" placeholder={t("f_volume")} required maxLength={60} className="h-12 rounded-xl bg-white/5 border-white/10 text-primary-foreground placeholder:text-primary-foreground/50" />
            </div>
            <Textarea name="message" placeholder={t("f_msg")} maxLength={1000} rows={4} className="rounded-xl bg-white/5 border-white/10 text-primary-foreground placeholder:text-primary-foreground/50" />
            <Button type="submit" disabled={loading} size="lg" className="w-full h-12 rounded-xl bg-primary-foreground text-primary-deep hover:bg-primary-foreground/90">
              {t("f_send_dealer")} <ArrowRight className="ml-1 size-4" />
            </Button>
          </form>
        </div>
      </div>
