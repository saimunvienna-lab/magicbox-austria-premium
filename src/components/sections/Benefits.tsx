import { Wallet, PackageX, Zap, LayoutGrid, TrendingUp, Sparkle } from "lucide-react";
import { useI18n } from "@/lib/i18n";

const Benefits = () => {
  const { t } = useI18n();
  const items = [
    { icon: Wallet, t: t("b1_t"), d: t("b1_d") },
    { icon: PackageX, t: t("b2_t"), d: t("b2_d") },
    { icon: Zap, t: t("b3_t"), d: t("b3_d") },
    { icon: LayoutGrid, t: t("b4_t"), d: t("b4_d") },
    { icon: TrendingUp, t: t("b5_t"), d: t("b5_d") },
    { icon: Sparkle, t: t("b6_t"), d: t("b6_d") },
  ];
  return (
