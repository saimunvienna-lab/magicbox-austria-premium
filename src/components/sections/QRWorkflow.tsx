...
const DB = [
  ...
  {"b":"Apple","m":"iPhone 15 Pro","k":"K10"},
  {"b":"Apple","m":"iPhone 15 Pro Max","k":"K11"},
  ...
  {"b":"Infinix","m":"Infinix Note 12","k":"K21"},{"b":"Infinix","m":"Infinix Hot 11","k":"K21"},
  {"b":"Huawei","m":"Huawei nova Y61","k":"K21"},
  ...
  {"b":"Redmi","m":"Redmi Note 10S","k":"K25"},{"b":"Redmi","m":"Redmi Note 10","k":"K25"},
  {"b":"Vivo","m":"vivo V20 Pro","k":"K25"},
  {"b":"Samsung","m":"Samsung Galaxy A14","k":"K26"},{"b":"Samsung","m":"Samsung Galaxy M14","k":"K26"},
  {"b":"Redmi","m":"Redmi A3","k":"K26"},{"b":"Redmi","m":"Redmi 12C","k":"K26"},
  {"b":"Xiaomi","m":"Xiaomi Poco C40","k":"K26"},
  ...
  {"b":"Redmi","m":"Redmi Note 11","k":"K30"},{"b":"Xiaomi","m":"Xiaomi Poco M4 Pro","k":"K30"},
  {"b":"Tecno","m":"Tecno Pova 3","k":"K31"},
...
const steps = (de: boolean) => [
  {
    n: "01",
    label: de ? "Schritt 1" : "Step 1",
    heading: de ? "QR-Code scannen" : "Scan the QR Code",
    desc: de
      ? "Jede MagicBox trägt einen eindeutigen QR. Ein Scan öffnet sofort den Inventar-Finder — kein Login, keine App."
      : "Every MagicBox carries a unique QR code. One scan opens the inventory finder instantly — no login, no app.",
  },
  {
    n: "02",
    label: de ? "Schritt 2" : "Step 2",
    heading: de ? "Modell identifizieren" : "Identify the model",
    desc: de
      ? "2086 Smartphone-Modelle, 48+ Marken — das System zeigt sofort die exakte K-Nummer. Null Verwechslungen."
      : "2086 smartphone models, 48+ brands — the system instantly shows the exact K-number. Zero confusion.",
  },
  {
    n: "03",
    label: de ? "Schritt 3" : "Step 3",
    heading: de ? "K-Schublade öffnen" : "Open the K-drawer",
    desc: de
      ? "Jede Schublade ist nach K-Nummern sortiert. Das System nennt die exakte Schublade — einfach öffnen."
      : "Every drawer is sorted by K-number. The system names the exact drawer — just open it and take out the glass.",
  },
  {
    n: "04",
    label: de ? "Schritt 4" : "Step 4",
    heading: de ? "Schutzglas anbringen" : "Install the glass",
    desc: de
      ? "Passgenau. Sofort. Kein Ausschuss, kein Fehlkauf — die richtige Folie für jedes Gerät, auf Anhieb."
      : "Perfect fit. First try. No wrong purchases, no waste — the right protector for every device, every time.",
  },
];
...
const QRWorkflow = () => {
  ...
  const results = DB.filter((d) =>
    (!brand || d.b === brand) &&
    (!query.trim() ||
      d.m.toLowerCase().includes(query.toLowerCase()) ||
      d.k.toLowerCase().includes(query.toLowerCase()))
  );
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 sm:mb-20">
          ...
          <p className="mt-5 text-lg sm:text-xl text-muted-foreground max-w-xl mx-auto leading-relaxed">
            {de
              ? "Vom QR-Code zur richtigen Schublade — in unter 10 Sekunden."
              : "From QR code to the right drawer — in under 10 seconds."}
          </p>
        </div>
        ...
        <div className="flex justify-center mb-14">
          <div className="inline-flex gap-1.5 bg-secondary/60 backdrop-blur-sm border border-border/50 rounded-2xl p-1.5">
            {(
              [
                ["how",  de ? "So funktioniert's" : "How it works"],
                ["find", de ? "Modell suchen"      : "Find model"],
              ] as const
            ).map(([key, label]) => (
              <button
                key={key}
        ...
        {tab === "how" && (
          <div className="grid lg:grid-cols-2 gap-12 xl:gap-16 items-start">
            ...
            <div className="relative">
              ...
              <div className="absolute -top-5 -right-4 z-20 hidden sm:flex items-center gap-4 bg-background/95 backdrop-blur-sm border border-border rounded-2xl px-5 py-3.5 shadow-xl">
                <div className="text-center">
                  <p className="text-2xl font-bold text-primary leading-none">2086</p>
                  <p className="text-xs text-muted-foreground mt-0.5">{de ? "Modelle" : "Models"}</p>
                </div>
                <div className="w-px h-9 bg-border" />
                <div className="text-center">
                  <p className="text-2xl font-bold text-primary leading-none">48+</p>
                  <p className="text-xs text-muted-foreground mt-0.5">{de ? "Marken" : "Brands"}</p>
                </div>
                <div className="w-px h-9 bg-border" />
                <div className="text-center">
                  <p className="text-2xl font-bold text-primary leading-none">K65+</p>
                  <p className="text-xs text-muted-foreground mt-0.5">{de ? "Serien" : "Series"}</p>
                </div>
              </div>
              ...
              <div className="relative rounded-3xl overflow-hidden aspect-[4/5] shadow-2xl ring-1 ring-border/20">
                <img
                  ...
                  alt={de ? "Mitarbeiter scannt QR-Code mit Smartphone in einem Handy-Shop" : "Employee scanning QR code with smartphone in a mobile phone shop"}
                  className="absolute inset-0 w-full h-full object-cover"
                  loading="lazy"
                />
                {/* Gradient overlay — brand-consistent blue tint */}
                ...
                <div className="absolute left-8 right-8 top-[12%] bottom-[38%] rounded-2xl border border-primary/40 overflow-hidden">
                  <div
                    ...
                    style={{ animation: "qrScan 2.2s ease-in-out infinite" }}
                  />
                  {/* Corner accents */}
                        ...
                        {STEPS.map((_, i) => (
                          <button
                            ...
                            className={`h-1.5 rounded-full transition-all duration-300 ${
                              activeStep === i ? "w-6 bg-primary" : "w-1.5 bg-border"
                            }`}
                          />
                        ))}
                      </div>
            ...
            <div className="flex flex-col gap-3 lg:pt-8">
                ...
                <div
                  ...
                  className={`flex gap-5 rounded-2xl border cursor-pointer transition-all duration-300 p-5 select-none ${
                    activeStep === i
                      ...
                      : "border-border/60 bg-background/60 hover:border-border hover:bg-secondary/30"
                  }`}
                >
                  {/* Number bubble */}
                  <div
                    className={`flex-shrink-0 w-11 h-11 rounded-xl flex items-center justify-center text-sm font-bold transition-all duration-300 ${
                      activeStep === i
                  ...
                  <div className="flex-1 min-w-0 pt-0.5">
                    <p className={`text-xs font-bold uppercase tracking-[0.12em] mb-1 transition-colors ${
                    ...
                    <div
                      className={`overflow-hidden transition-all duration-300 ${
                        activeStep === i ? "max-h-28 opacity-100 mt-2" : "max-h-0 opacity-0"
                      }`}
                    >
              ...
              >
                {de ? "Jetzt Modell suchen" : "Find your model now"}
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="relative mb-4">
              ...
              <input
                ...
                placeholder={
                  de
                    ? "Modell eingeben… z.B. iPhone 17 PRO MAX, Galaxy S25 Ultra, Poco F7"
                    : "Enter model… e.g. iPhone 17 PRO MAX, Galaxy S25 Ultra, Poco F7"
                }
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              <button
                onClick={() => { setBrand(""); setSelected(null); }}
              ...
              {BRANDS.map(b => (
                <button
                  key={b}
                  onClick={() => { setBrand(brand === b ? "" : b); setSelected(null); }}
                  className={`px-4 py-2 rounded-full text-sm font-semibold border transition-all ${
                    brand === b
              ...
              <div className="mb-6 rounded-2xl border border-primary/25 bg-primary/5 p-6 animate-fade-up">
                <div className="flex items-start justify-between mb-5">
                  ...
                  <div className="text-right ml-4">
                    ...
                    <p className="text-xs text-muted-foreground uppercase tracking-wider mt-1">K-{de ? "Serie" : "Series"}</p>
                  </div>
                </div>
                <div className="grid grid-cols-3 gap-3 pt-4 border-t border-border/50">
                  {[
                    ["📱", de ? "QR scannen" : "Scan QR", "MagicBox"],
                    ["📦", de ? "Schublade" : "Drawer", selected.k],
                    ["✅", de ? "Anbringen" : "Install", de ? "Passgenau" : "Perfect fit"],
            ...
            {showResults ? (
              <>
                <p className="text-sm text-muted-foreground mb-3">
                  ...
                  {de
                    ? `Gerät${results.length !== 1 ? "e" : ""} gefunden`
                    : `device${results.length !== 1 ? "s" : ""} found`}
                </p>
                {results.length === 0 ? (
                  <div className="text-center py-14 text-muted-foreground text-base">
                    {de ? "Kein Gerät gefunden — Suchbegriff anpassen" : "No device found — try adjusting your search"}
                  </div>
                ) : (
                    ...
                    {results.slice(0, 60).map((d, i) => (
                      ...
                      >
                        ...
                        <div className="flex-shrink-0 bg-primary/10 border border-primary/20 rounded-xl px-4 py-2.5 text-center min-w-[62px]">
                          ...
                          <p className="text-xs text-primary/60 mt-0.5">{de ? "Serie" : "Series"}</p>
                        </div>
                      </button>
                    ))}
                    {results.length > 60 && (
                      <p className="text-center text-sm text-muted-foreground py-3 border-t border-border">
                        + {results.length - 60} {de ? "weitere — Suche verfeinern" : "more — refine your search"}
                      </p>
                    )}
                  </div>
                )}
              ...
              <div className="flex flex-col items-center justify-center py-16 text-muted-foreground gap-4">
                ...
                <p className="text-base">
                  {de ? "Modellnamen eingeben oder Marke wählen" : "Enter a model name or select a brand"}
                </p>
              </div>
            )}
          </div>
